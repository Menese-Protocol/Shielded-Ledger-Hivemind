...
let tOff : CT.Tuple = { last_block_index = ?idx; last_block_hash = ?tipHash; note_count = nc; note_root = noteRoot; encoding_version = ev; archive_manifest = archive; audit_digest = audit; pir2_boundary = null; detect_stream = null; vk_anchor = null };
